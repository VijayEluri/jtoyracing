...
/**
 * Simulated vehicle controlled by the computer. It is based on the Steering Behaviors
 * algorithms (http://www.red3d.com/cwr/steer/gdc99/).
 *
...
public class ComputerVehicle extends Vehicle {
	...
	public ComputerVehicle(PhysicsSpace physicsSpace, Vector2f initialPosition, ColorRGBA color) {
